...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMfaInitializationRequired(MfaInitializationRequiredException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(e.getErrorCode(), e.getMessage(), e.getAdditionalData());
    ...
    public ResponseEntity<ErrorResponse> handleExpiredJwtException(ExpiredJwtException e) {
        log.warn("JWT expired: {}", e.getMessage(), e);

        ErrorResponse errorResponse = new ErrorResponse("JWT_EXPIRED", "JWT 토큰이 만료되었습니다.");
    ...
    public ResponseEntity<ErrorResponse> handleJwtException(JwtException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse("JWT_ERROR", e.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAuthorizationDeniedException(AuthorizationDeniedException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse("AUTHORIZATION_DENIED", "이 리소스에 접근할 권한이 없습니다.");
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgumentException(IllegalArgumentException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse("ILLEGAL_ARGUMENT", "잘못된 요청 값입니다.");
    ...
    public ResponseEntity<ErrorResponse> handleIllegalStateException(IllegalStateException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse("ILLEGAL_STATE", "처리할 수 없는 상태입니다.");
    ...
    public ResponseEntity<ErrorResponse> handleGeneralException(Exception e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse("INTERNAL_SERVER_ERROR", "내부 서버 오류가 발생했습니다.");
